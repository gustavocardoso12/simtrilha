...
@Entity(name="TbFORMACAO")
@Table(name="\"TBFORMACAO\"")
public class TbFORMACAOEntity extends BaseEntity implements Serializable {

    private static final long serialVersionUID = 1L;

    @Size(max = 50)
    @Column(length = 50, name="\"deSCFORMACAO\"")
    @NotNull
