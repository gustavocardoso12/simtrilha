...
@Entity(name="TbDEPTO")
@Table(name="TB_DEPTO")
public class TbDEPTOEntity extends BaseEntity implements Serializable {

    private static final long serialVersionUID = 1L;

    @Size(max = 50)
    @Column(length = 50, name="DESC_DEPTO")
    @NotNull
    private String deSCDEPTO;

    @ManyToOne(optional=true)
    @JoinColumn(name = "IDAREA_ID", referencedColumnName = "ID")
    private TbAREAEntity idAREA;
    ...
    public TbAREAEntity getIdAREA() {
        return this.idAREA;
    }

    public void setIdAREA(TbAREAEntity tbAREA) {
        this.idAREA = tbAREA;
    }
