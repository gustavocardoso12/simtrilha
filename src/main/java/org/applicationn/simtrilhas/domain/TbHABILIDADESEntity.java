...
@Entity(name="TbHABILIDADES")
@Table(name="\"TBHABILIDADES\"")
public class TbHABILIDADESEntity extends BaseEntity implements Serializable {

    private static final long serialVersionUID = 1L;

    @Size(max = 200)
    @Column(length = 200, name="\"deSCHABILIDADES\"")
    @NotNull
